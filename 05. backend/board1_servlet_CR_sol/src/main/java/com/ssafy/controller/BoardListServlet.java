...
//		out.println("                  </a>");
//		out.println("                </td>");
//		out.println("                <td>안효인</td>");
//		out.println("                <td>10</td>");
//		out.println("                <td>22.07.07</td>");
//		out.println("              </tr>");
		
		// 글목록 성공 응답 : 글목록 존재하면 글목록 반복 출력 응답 
		if (!list.isEmpty()) {
...
//				TODO: 글목록에서 제목을 클릭하면 해당 글번호 상세조회 요청하기
				out.println("                  <a");
//				out.println("                    href=\"#\"");
				out.println("                    href='/board/view?articleNo=" + boardDto.getArticleNo() + "'");
				out.println("                    class=\"article-title link-dark\"");
//				out.println("                    data-no=\"" + boardDto.getArticleNo() + ""\");
			...
			// 글목록 실패 응답
			out.println("              <tr class=\"text-center\">");
			out.println("              <th colspan='5'>현재 등록된 게시글이 없습니다.</th>");	
			out.println("              </tr>");	
