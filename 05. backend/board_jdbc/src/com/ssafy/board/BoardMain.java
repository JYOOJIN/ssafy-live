...
//		TODO : Service의 searchListAll을 호출하세요!!!
		List<BoardDto> list = BoardServiceImpl.getInstance().searchListAll();
//		END
...
//		TODO : Service의 searchListBySubject을 호출하세요!!!
		List<BoardDto> list = BoardServiceImpl.getInstance().searchListBySubject(subject);
//		END
...
//		TODO : Service의 viewArticle을 호출하세요!!!
		BoardDto boardDto = BoardServiceImpl.getInstance().viewArticle(no);
//		END		
