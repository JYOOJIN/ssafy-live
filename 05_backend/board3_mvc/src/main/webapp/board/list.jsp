...
List<BoardDto> list = (List<BoardDto>)request.getAttribute("articles"); //List로 담았으니 List로 뺀다
%>
<!DOCTYPE html>
<html lang="ko">
  <head>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-12">
          <h2 class="my-3 py-3 shadow-sm bg-light text-center">
            <mark class="sky">글목록 ver.1.0</mark>
          </h2>
        </div>
        <div class="col-lg-8 col-md-10 col-sm-12">
    ...
    <script>
      ...
      titles.forEach(function (title) {
        title.addEventListener("click", function () {
          ...
          // location.href는 get방식이다. url에 데이터 넣어서 전달. 
